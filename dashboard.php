                ...
                <div class="content-wrap">
                    ...
                    <div class="wrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <section class="dash-tile bg-danger">
                                    ...
                                    <div class="mb20"></div>
                                    <div class="tile-chart tile-line" style="height: 40px;"></div>
                                    <div class="tile-footer">
                                        800ms intervals
                                    </div>
                                </section>
                        ...
                        <div class="row">
                                    ...
                                    <div class="row equal-blocks no-m">
                                        ...
                                        <div class="col-xs-6 block bg-primary brtr brbr p25">
                                            ...
                                            <div class="widget-body">
                                                <em>Just released a new wordpress theme. Check it out: <a href="../../marketplace.envato.com/index8a18.html?ref=iamnyasha">twitter.com/WGnEavg6Ok</a> — Envanto(@Envanto) #Portfolio <a href="#" class="small">July 31, 2014</a></em>
                                            </div>
                                        </div>
                                    </div>
                                </section>
                            ...
                            <div class="col-md-12 col-lg-4">
                                ...
                                <section class="widget" data-animation="fadeInUp">
                                ...
                                <section class="widget bg-danger">
                                    <div class="cover rounded" style="background-image: url(img/DeathtoStock_Wired5.jpg)"></div>
				  ...
				  <!-- page level scripts -->
    <script src="plugins/skycons.js"></script>
